...
public class AdminController {
    ...
    public AdminController(UtilisateurService utilisateurService, CategorieService categorieService, CategorieService categorieService1) {
    ...
    public String dashboard(Model model) {
        ...
        return "admin/dashboard"; // correspond à /templates/admin/dashboard.html
    }
